    ...
    <div className="">
      ...
      <div className="bg-[#F0ECFF] py-8 mt-8 flex flex-col items-center text-center">
        ...
        <div className="flex flex-col items-center gap-12 max-w-[1210px]">
          ...
          <span className="bg-[#6945FF] text-white py-3 px-4 rounded-lg w-full h-[48px] flex items-center justify-start font-bold text-xl mx-auto mt-6">
            ...
            <div className="flex gap-16 w-full">
              <div className="flex flex-col gap-4 items-center w-full">
                {[
                  ...
                  <div
                    key={index}
                    className="w-[573px] h-[160px] p-4 rounded-lg border border-[#444444] bg-white shadow-md flex items-center gap-4"
                  >
                    <img
                      src={card.imgSrc}
                      alt={card.name}
            ...
            <div className="flex gap-16">
              <div className="flex flex-col gap-4 items-center">
                {[
                  ...
                  <div
                    key={index}
                    className="w-[573px] h-[150px] p-4 rounded-lg border border-[#444444] bg-white shadow-md flex items-center gap-4"
                  >
                    <img
                      src={card.imgSrc}
                      alt={card.name}
              ...
              <div className="flex flex-col gap-4 items-center">
                {[
                  ...
                  <div
                    key={index}
                    className="w-[573px] h-[150px] mr-30 p-4 rounded-lg border border-[#444444] bg-white shadow-md flex items-center gap-4"
                  >
                    <img
                      src={card.imgSrc}
                      alt={card.name}
