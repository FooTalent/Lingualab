...
export default function ResourceCard({ resource, deleteFunc, editFunc, onSelect }) {
    const { _id } = resource

    return (
        <article className={`flex flex-wrap ${onSelect ? 'w-[90%]' : 'w-full'} items-center justify-between shadow-home py-3 md:py-4 px-4 md:px-6 lg:px-8 lg:py-6 gap-y-4 lg:gap-0 rounded-lg text-card`}>
            ...
            <div className="flex w-1/6 md:w-auto self-end md:items-center md:self-center justify-evenly gap-2 md:gap-6">
                <button
                ...
                <button onClick={() => editFunc(_id)} className="text-darkGray hover:text-Grey flex items-center justify-center">
