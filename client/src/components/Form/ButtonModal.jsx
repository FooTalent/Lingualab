...
export default function ButtonModal({ buttonAction, type, label }) {
    ...
    return (
        <button
            ...
            className={`outline-none border rounded-lg py-3 px-8 text-xl font-extrabold ease-out duration-600 tracking-wide ${type === 'prev' ? 'border-Purple text-Purple hover:bg-Purple hover:text-white hover:border-PurpleHover focus:border-PurpleHover' : 'border-Purple bg-Purple text-white hover:border-PurpleHover hover:bg-PurpleHover focus:border-PurpleHover'} whitespace-nowrap`}
